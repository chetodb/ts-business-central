...
- Run tests before submitting a PR to ensure no regressions.
...
- Ejecuta los tests antes de enviar una PR para asegurar que no hay regresiones.
...
2. Haz commit de tus cambios: `git commit -m "feat: añadir tal funcionalidad"`.
